...
{
    public class PalavraRpository : IPalavraRepository

        
    {
        private readonly MimicContext _banco;

        public PalavraRpository(MimicContext banco)
        {
            _banco = banco;
        }
        ...
        public PaginationList<Palavra> ObterPalavras(PalavraUrlQuery query)
        {
            ...
            {
                var quantidadeDeRegistros = item.Count();
                ...
                paginacao.TotalRegistros = quantidadeDeRegistros;
                paginacao.TotalPaginas = (int)Math.Ceiling((double) quantidadeDeRegistros/ query.PagRegistro.Value);
